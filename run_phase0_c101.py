"""Phase 0 standard ALNS for C101, seed 42."""
...
INSTANCE_NAME = "C101"
OUT_DIR = f"solutions/{INSTANCE_NAME}/sampling"
...
def main():
    ...
    print(f"Phase 0 standard — C101 25c, {ALNS_ITERATIONS} iter\n")
    ...
    for seed in SEEDS:
        ...
        with open(path, "w") as f:
            json.dump({"seed": seed, "exact_cost": exact_cost, "routes": routes}, f, indent=2)
